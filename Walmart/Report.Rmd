...
# nullIndex <- is.na(walmartRawValidate$FinelineNumber)&(walmartRawValidate$DepartmentDescription=="NULL")
# pharmIndex <- is.na(walmartRawValidate$FinelineNumber)&(walmartRawValidate$DepartmentDescription=="PHARMACY RX")
# 
# walmartRawValidate$FinelineNumber[nullIndex] <- -1
# walmartRawValidate$FinelineNumber[pharmIndex] <- -2
# 
# temp <- cbind(walmartRawValidate,TripType=NA)
# comboData <- rbind(walmartTrain,temp)
